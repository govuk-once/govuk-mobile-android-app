...
data class GovUkColourScheme(
    ...
    data class TextAndIcons(
        ...
        val buttonConnectedGroupFocused: Color,
        val icon: Color,
...
internal val LightColorScheme = GovUkColourScheme(
    textAndIcons = TextAndIcons(
        ...
        buttonConnectedGroupFocused = Black,
        icon = BluePrimary,
        iconPrimary = White,
...
internal val LocalColourScheme = staticCompositionLocalOf {
    GovUkColourScheme(
        textAndIcons = TextAndIcons(
            ...
            buttonConnectedGroupFocused = Color.Unspecified,
