...
interface UserRepo {
    ...
    suspend fun updateNotifications(consentStatus: ConsentStatus): Result<UpdateUser>
    suspend fun updateTermsAndConditions(consentStatus: ConsentStatus): Result<UpdateUser>
}
